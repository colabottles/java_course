...
public class PasswordValidator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The password you have proposed is valid.");
    ...
    public void printPasswordRules() {
        ...
        System.out.println("* not the same as your old password");
        System.out.println();
    }
    ...
    public void changePassword(String newPassword) {
        ...
        if (newPassword.equals(currentPassword)) {
            valid = false;
            errorMessage += "\n Your password msut be different from your current password.";
        }
    }
}
